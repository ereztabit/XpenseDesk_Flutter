...
- [ ] (in progress) Footer on mobile is too large -- should be a single line -- see docs/bugs/footer-mobile-too-large-single-line.md
- [ ] (in progress) Move Privacy Policy and Terms of Service into the main menu, below Contact Support -- see docs/bugs/move-legal-links-to-main-menu.md
- [ ] Organize the manager menu by context (grouped sections) -- see docs/bugs/organize-manager-menu-by-context.md
- [ ] (in progress) Auto-bump minor version in pubspec.yaml at commit time (staged into the commit) + show v(major.minor) at bottom of main menu (deployment verification) -- see docs/bugs/app-version-autobump-and-display-in-menu.md
