...
/// the breakdown bars. Owns only the By Employee / By Category toggle state;
/// fed pre-fetched rows by [SpendOverviewCard], which controls collapse and
/// renders this body only when expanded.
